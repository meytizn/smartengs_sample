...
export default function LatestProducts() {
  let products=[
    {id:uuidv4(),title:"tv",price:3000,image: "/images/tv.jpg", description:"samsung tv is the best"},
    {id:uuidv4(),title:"xbox",price:8000,image: "/images/tv.jpg", description:"xbox is the best"},
    {id:uuidv4(),title:"Iphone16",price:12000,image:"/images/tv.jpg" , description:"Iphone16 is the best"},
    {id:uuidv4(),title:"Laptop",price:9000,image:"/images/tv.jpg" , description:"Laptop is the best"},
  ...
  return (
    ...
    <div className='bg-red-800 p-5 text-white flex flex-row justify-around gap-5 md:gap-2  md:justify-center items-center content-center flex-wrap w-[100%]  text-center text-[20px]'>
      ...
      {products.map((product,index)=>(
        ...
        <div className='w-[100%]'><Image className='m-auto rounded-md' src={product.image} width={200} height={200} alt={product.title}/></div>
